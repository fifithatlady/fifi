...
class NannyFileStorage:
    """File storage class for nanny job-related data."""

    __engine = None
    __session = None

    def __init__(self):
        """Initialize NannyFileStorage with MySQL database."""
    ...
    def all(self, cls=None):
        ...
        objects = {}
        classes = [Nanny, Family, Application, Review]
        if cls:
            if cls in classes:
